...
.. literalinclude:: ../../../pyefun/文本操作实用函数_test.py
    :language: python
    :caption: 代码示例
    :linenos:
...
def 文本_取出现次数(欲处理文本: str, 欲查询的文本, 开始的位置=0, 结束的位置=0) -> int:
    ...
    Args:
        欲处理文本 (str): 参数说明。
        欲查询的文本: 参数说明。
        开始的位置 (可选): 参数说明。默认值为 0。
        结束的位置 (可选): 参数说明。默认值为 0。
...
def 文本_汉字转拼音(欲处理文本, 连接符='', 拼音风格=0, 遍历多音=False, 无拼音处理=0, 严格规范=False):
    ...
    Args:
        ...
        连接符 (可选): 参数说明。默认值为 ''。
        拼音风格 (可选): 参数说明。默认值为 0。
        遍历多音 (可选): 参数说明。默认值为 False。
        无拼音处理 (可选): 参数说明。默认值为 0。
        严格规范 (可选): 参数说明。默认值为 False。
