...
class Frame(wx.Frame):
    def __init__(self):
        ...
        self.滑块条2 = wx.Slider(self.启动窗口,size=(120, 22),pos=(292, 83),name='slider',minValue=1,maxValue=100,value=1,style=4)
        self.滑块条2.SetTickFreq(10)
        self.滑块条2.SetPageSize(5)
        self.整数微调框2 = wx.SpinCtrl(self.启动窗口,size=(60, 24),pos=(458, 78),name='wxSpinCtrl',min=0,max=100,initial=0,style=0)
        ...
        self.超级链接框4 = wx.adv.HyperlinkCtrl(self.启动窗口,size=(60, 22),pos=(541, 167),name='hyperlink',label='易起玩',url='www.012.plus',style=1)
        self.排序列表框2 = wx.adv.EditableListBox(self.启动窗口,size=(170, 140),pos=(638, 138),name='editableListBox',label='',style=1792)
        self.排序列表框2.SetStrings([])
        self.引导按钮2 = wx.adv.CommandLinkButton(self.启动窗口,size=(110, 50),pos=(55, 260),name='button',mainLabel='标签内容',note='描述内容')
        ...
        self.分组单选框2 = wx.RadioBox(self.启动窗口,size=(120, 60),pos=(52, 365),label='单选项',choices=['示例1', '示例2'],majorDimension=0,name='radioBox',style=4)
        self.颜色选择器2 =wx.ColourPickerCtrl(self.启动窗口,size=(80, 28),pos=(76, 207),colour=(0, 0, 0, 255),name='colourpicker',style=0)
        self.图文按钮2 = lib_button.ThemedGenBitmapTextButton(self.启动窗口,size=(100, 32),pos=(208, 230),bitmap=None,label='图文按钮',name='genbutton')
        self.图文按钮L2 = lib_gb.GradientButton(self.启动窗口,size=(100, 32),pos=(359, 228),bitmap=None,label='图文按钮L',name='gradientbutton')
        self.图文按钮L2.SetForegroundColour((255, 255, 255, 255))
        self.超级链接框L2 = lib_hyperlink.HyperLinkCtrl(self.启动窗口,size=(80, 22),pos=(503, 234),name='staticText',label='易起玩',URL='www.012.plus')
