...
class 圆饼图:
    ...
    def __init__(self, 标签列表=[], 数值列表=[], 颜色列表=[], 间隔列表=[], 起始角度=90, 数值显示距离=0.6, 保留小数位数=2, 阴影=False, 显示图例=True, 宽高=()):
        ...
        Args:
            ...
            颜色列表 (可选): 参数说明。默认值为 []。
            间隔列表 (可选): 参数说明。默认值为 []。
            起始角度 (可选): 参数说明。默认值为 90。
            数值显示距离 (可选): 参数说明。默认值为 0.6。
            保留小数位数 (可选): 参数说明。默认值为 2。
            阴影 (可选): 参数说明。默认值为 False。
            显示图例 (可选): 参数说明。默认值为 True。
            宽高 (可选): 参数说明。默认值为 ()。
...
class 柱状图:
    def __init__(self, 宽高=(), 标题="", 横向标题="", 纵向标题="", 标签列表=[], 数值列表=[], 名称列表=[], 颜色列表=[], 柱宽=0.25, 标题字体大小=20,
        ...
        Args:
            ...
            名称列表 (可选): 参数说明。默认值为 []。
            颜色列表 (可选): 参数说明。默认值为 []。
            柱宽 (可选): 参数说明。默认值为 0.25。
            标题字体大小 (可选): 参数说明。默认值为 20。
            显示项目名称 (可选): 参数说明。默认值为 True。
...
class 折线图:
    def __init__(self, 宽高=(), 标题="", 横向标题="", 纵向标题="", 标签列表=[], 数值列表=[], 名称列表=[], 颜色列表=[], 标题字体大小=20, 显示项目名称=True,
        ...
        Args:
            ...
            标题字体大小 (可选): 参数说明。默认值为 20。
            显示项目名称 (可选): 参数说明。默认值为 True。
            显示数值 (可选): 参数说明。默认值为 True。
            显示圆点 (可选): 参数说明。默认值为 True。
